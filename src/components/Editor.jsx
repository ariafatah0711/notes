...
return (
  ...
  <textarea
    id="text_gist"
    className="w-full flex-grow border-2 border-gray-300 rounded-lg p-4 text-base sm:text-sm md:text-lg lg:text-xl text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none overflow-x-auto whitespace-nowrap"
    value={value}
